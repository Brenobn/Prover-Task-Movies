			...
			<main className="w-full overflow-y-auto">
				<div className="p-8">
					<div className="flex items-center justify-around gap-[460px]">
						<h1 className="text-white font-secondary text-3xl font-normal">
							Meus Filmes
						</h1>

						<a
							href="#"
							className="inline-flex h-12 w-52 items-center gap-2 shrink-0 p-7 border-0 mt-4 rounded-lg font-medium bg-[#FF859B] text-[#3E3B47] disabled:opacity-50"
						>
							<FiPlus />
							Adicionar filme
						</a>
					...
					<div className="inline-flex justify-center flex-col items-center gap-6 my-4 mx-auto mt-10">
						<Section>
							<StarRating />
							<p className="text-[#999591] font-primary text-base font-normal overflow-hidden">
					...
					<div className="inline-flex justify-center flex-col items-center gap-6 my-4 mx-auto">
						<Section>
							<StarRating />
							<p className="text-[#999591] font-primary text-base font-normal overflow-hidden">
								Pragas nas colheitas fizeram a civilização humana regredir para
